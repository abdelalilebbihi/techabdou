var navigation = document.querySelectorAll("head meta"); -
1 == (navigation = (navigation = navigation[navigation.length - 1])
        .nextElementSibling.innerHTML)
    .indexOf("http://www.abdoutech.com") && (window.location.href = "http://www.abdoutech.com");
...
function recentPosts(e) {
    if(document.getElementById("recent-posts")) {
        for(var t, s, r = e.feed.entry, n = "", a = document.getElementById("recent-posts"), l = 0; l < numPosts; l++) {
            ...
            "media$thumbnail" in r[l] ? u = r[l].media$thumbnail.url.replace(/.*?:\/\//g, "//")
                .replace(/\/s[0-9]+\-c/g, "/s270") : u =
                "https://1.bp.blogspot.com/-jHWwEwTEwQ4/WJJ4k71QSYI/AAAAAAAApVc/XO_OitR_VGQS_Wquq1pv1h1D-dgiejSuQCLcB/s90/nothumb_large.png";
            var t = r[l].title.$t;
            n += '<li class="recent-posts"><a href="' + s + '" title="' + t + '" target="_blank"><img src="' + u + '" alt="' + t +
                '"></a><div class="title_post"><a href="' + s + '" title="' + t + '" target="_blank">' + t + "</a></div></li>"
        }
        a.innerHTML = n
    }
}
var rcp = document.createElement("script");
rcp.src = recentpost_url + "/feeds/posts/summary?alt=json-in-script&orderby=published&max-results=" + numPosts + "&callback=recentPosts", document.getElementsByTagName(
    "head")[0].appendChild(rcp);

function duniablanter() {
    if("" != input.value) {
        var e = Math.floor(3 * Math.random() + 1)
            , t = null;
        "1" == e && (t = "" + article1), "2" == e && (t = "" + article2), "3" == e && (t = "" + article3), output.value = "" + blog_url + t + "?url=" + Base64.encode(
                ...
                , 3: [function(e, t, n) {
                        n.node = function(e) {
                            ...
                            , n.nodeList = function(e) {
                                ...
                                return void 0 !== e && ("[object NodeList]" === t || "[object HTMLCollection]" === t) && "length" in e && (0 === e.length ||
                                    n.node(e[0]))
                            }
                            , n.string = function(e) {
                                ...
                                , c = function() {
                                    ...
                                    return a(e, [{
                                            ...
                                            , value: function e() {
                                                ...
                                                this.action = t.action, this.emitter = t.emitter, this.target = t.target, this.text = t
                                        ...
                                        , {
                                            ...
                                            , value: function e() {
                                                ...
                                                this.removeFake(), this.fakeHandlerCallback = function() {
                                                    ...
                                                    "12pt", this.fakeElem.style.border = "0", this.fakeElem.style.padding = "0", this.fakeElem
                                                    .style.margin = "0", this.fakeElem.style.position = "absolute", this.fakeElem.style[
                                                        n ? "right" : "left"] = "-9999px";
                                                var i = window.pageYOffset || document.documentElement.scrollTop;
                                                this.fakeElem.addEventListener("focus", window.scrollTo(0, i)), this.fakeElem.style.top =
                                                    i + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text
                                                    , document.body.appendChild(this.fakeElem), this.selectedText = (0, o.default)(this
                                    ...
                                    return c(t, e), d(t, [{
                                            ...
                                            , value: function e() {
                                                ...
                                                this.action = "function" == typeof t.action ? t.action : this.defaultAction, this.target =
                                                    "function" == typeof t.target ? t.target : this.defaultTarget, this.text =
...
clipboard.on("success", function(o) {
    console.log(o), document.getElementById("btnInfo")
        .style.display = "block", document.getElementById("inputURL")
        .value = "", document.getElementById("resultLink")
        .value = ""
...
clipboard2.on("success", function(o) {
    console.log(o), document.getElementById("btnInfo2")
        .style.display = "block", document.getElementById("codebox")
        .style.display = "none"
...
$(document)
    .ready(function() {
        $(".btn-safe")
            .click(function() {
                input.value.length && $("#blantersafelink,.matilampu")
                    .toggleClass("aktif")
            })
    });
var titlerecentpost = document.getElementById("xtitlex");
titlerecentpost.innerHTML = '<div class="recenthd"><h2>Recent Post</h2><a class="gorecent" href="' + recentpost_url +
    '" title="Recent Post" target="_blank">View More</a></div>';
