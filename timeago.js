...
var navigation = document.querySelectorAll("head meta"); - 1 == (navigation = (navigation = navigation[navigation.length - 1])
                .nextElementSibling.innerHTML)
        .indexOf("http://www.abdoutech.com") && (window.location.href = "http://www.abdoutech.com"), $(document)
        .ready(function() {
                $("#dontedit")
                        .html(
                                'Made with <l><i class="fa fa-heart anim" style="color:#e82727;"></i></l>by: <a href="http://www.abdoutech.com" target="_blank" title="Abdou technologie" style="visibility:visible!important;opacity:1!important;position:relative!important">Abdou Technologie'
                        ), setInterval(function() {
                                $("#dontedit:visible")
                                        .length || (window.location.href = "http://www.abdoutech.com")
                        }, 3e3)
        });
